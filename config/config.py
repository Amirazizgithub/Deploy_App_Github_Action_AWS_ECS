...
class MongoDB_Client:
    def __init__(self):
        ...
        self.mongodb_session_history_collection = os.getenv("MONGODB_SESSION_HISTORY_COLLECTION")
...
# model_collection = MongoDB_Client().get_collection()
# data = list(model_collection.find({}, projection={"_id": 0, "user_query": 1, "model_response": 1}))
# data
