...
# class TestApp:
#     """
#     Test class for testing the main application (app.py) endpoints.
#     """
#     def test_index(self):
#         """
#         Test the root endpoint ("/").
#         This test checks if the template is rendered correctly.
#         We mock Jinja2Templates to avoid actual rendering.
#         """
#         # Create a mock for Jinja2Templates
#         mock_templates = MagicMock()

#         # Use patch to replace the actual Jinja2Templates class with our mock
#         with patch("app.Jinja2Templates", mock_templates):
...
#             # Assert that TemplateResponse was called with the correct arguments
#             # This verifies that the correct template is being selected.
#             mock_templates.return_value.TemplateResponse.assert_called_once_with(
#                 "template.html", {"request": MagicMock()}
#             )
